...
contract BullBear is ERC721, ERC721Enumerable, ERC721URIStorage, AutomationCompatibleInterface, Ownable, VRFConsumerBaseV2  {
    ...
    bytes32 keyHash =  0x474e34a077df58807dbe9c96d3c009b23b3c6d0cce433e59bbf5b34f823bc56c; // keyhash for sepolia
    ...
    */
    ...
    // Setup VRF. Sepolia VRF Coordinator 0x8103b0a8a00be2ddc778e6e7eaa21791cd364625
    constructor(uint updateInterval, address _pricefeed, address _vrfCoordinator) ERC721("Bull&Bear", "BBTK") VRFConsumerBaseV2(_vrfCoordinator) {
        ...
        // BTC/USD Price Feed Contract Address on Sepolia: 0x1b44F3514812d835EB1BDB0acB33d3fA3351Ee43
